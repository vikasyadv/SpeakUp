...
class FeedbackServiceTest {
    ...
    @Test
    void generateOrGetFeedback_incompleteSession_throwsIllegalArgument() {
    ...
    @Test
    void generateOrGetFeedback_shortTranscript_throwsIllegalArgument() {
        completedSession.setTranscript("Too short here"); // 3 words
        when(sessionRepository.findById(10L)).thenReturn(Optional.of(completedSession));
        when(feedbackRepository.findBySessionId(10L)).thenReturn(Optional.empty());
    ...
    @Test
    void generateOrGetFeedback_existingFeedback_returnsCachedWithoutCallingAi() {
